...
<p align="center">
  ...
  <a href="https://github.com/cpdevs/mediadevices/actions"><img src="https://github.com/cpdevs/mediadevices/workflows/CI/badge.svg?branch=master" alt="Build status"></a> 
  <a href="https://pkg.go.dev/github.com/cpdevs/mediadevices"><img src="https://godoc.org/github.com/cpdevs/mediadevices?status.svg" alt="GoDoc"></a>
  <a href="https://codecov.io/gh/cpdevs/mediadevices"><img src="https://codecov.io/gh/cpdevs/mediadevices/branch/master/graph/badge.svg" alt="Coverage Status"></a>
...
`go get -u github.com/cpdevs/mediadevices`
...
import (
	"github.com/cpdevs/mediadevices"
	"github.com/cpdevs/mediadevices/pkg/codec/x264"      // This is required to use H264 video encoder
	_ "github.com/cpdevs/mediadevices/pkg/driver/camera" // This is required to register camera adapter
)
...
* Package: [github.com/cpdevs/mediadevices/pkg/codec/x264](https://pkg.go.dev/github.com/cpdevs/mediadevices/pkg/codec/x264)
* Installation:
...
* Package: [github.com/cpdevs/mediadevices/pkg/codec/mmal](https://pkg.go.dev/github.com/cpdevs/mediadevices/pkg/codec/mmal)
...
* Package: [github.com/cpdevs/mediadevices/pkg/codec/openh264](https://pkg.go.dev/github.com/cpdevs/mediadevices/pkg/codec/openh264)
...
* Package: [github.com/cpdevs/mediadevices/pkg/codec/vpx](https://pkg.go.dev/github.com/cpdevs/mediadevices/pkg/codec/vpx)
* Installation:
...
* Package: [github.com/cpdevs/mediadevices/pkg/codec/vaapi](https://pkg.go.dev/github.com/cpdevs/mediadevices/pkg/codec/vaapi)
* Installation:
...
* Package: [github.com/cpdevs/mediadevices/pkg/codec/opus](https://pkg.go.dev/github.com/cpdevs/mediadevices/pkg/codec/opus)
* Installation:
...
* Driver was not imported as a side effect in your program, e.g. `import _ github.com/cpdevs/mediadevices/pkg/driver/camera`
